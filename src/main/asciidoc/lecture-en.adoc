...
[%step]
[none]
* image:thumbs-down.png[] No guarantees to behave the same as the real system.
* image:thumbs-down.png[] Writing a bug-to-bug compatible mock is harder than to write the real system, no one ever does it.
|
|
|===
...
^.^|
*Testcontainers*
| image:thumbs-up.png[] If tests are fast and reliable, one wants to run them more often and write more of them
|

...
[none]
* We sent "ping" and expect the system to return _a single_ response "pong".
...
* image:index_up.png[] If necessary, a small number of tests must be conducted on a containerized Kafka cluster.
